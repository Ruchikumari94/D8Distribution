...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . ($context["icon_position"] ?? null))) : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/input/input--button.html.twig", "/var/www/html/d8distribution/themes/bootstrap/templates/input/input--button.html.twig");
    }
}
